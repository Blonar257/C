...
int main() {
  ...
  // The type of the variable determines the size and layout of the variable's
  // memory The type of the variable also determines the range of values that
  // can be stored within that memory The type of the variable also determines
